...
/**
 * Android: checks if the device is running Amazon Fire OS
 *
 * @param {Function} successCallback - called with true/false result
 * @param {Function} errorCallback - called on error
 */
exports.isFireOS = function (successCallback, errorCallback) {
  cordova.exec(
    function (result) {
...
/**
 * Android: checks if the device is an Amazon Fire TV
 *
 * @param {Function} successCallback - called with true/false result
 * @param {Function} errorCallback - called on error
 */
exports.isFireTV = function (successCallback, errorCallback) {
  cordova.exec(
    function (result) {
      successCallback(result === 1);
    },
...
/**
 * Android: gets the Fire OS device type description
 *
 * @param {Function} successCallback - called with device type string
 * @param {Function} errorCallback - called on error
 */
...
/**
 * Android: manually test the autostart functionality without rebooting
 *
 * @param {Function} successCallback - called on success
 * @param {Function} errorCallback - called on error
 */
exports.testAutoStart = function (successCallback, errorCallback) {
  cordova.exec(successCallback, errorCallback, "AutoStart", "testAutoStart", []);
};
